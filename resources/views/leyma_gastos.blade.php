...
@section('title', 'Leyma Créditos - Gastos')
...
@section('content')
                        ...
                        <div class="card bg-corner-img mb-2">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-9">
                                        <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Gastos Totales</p>
                                        <h4 id="gastos_totales" class="mt-1 mb-0 fw-medium">—</h4>
                                    </div>
                                    <div class="col-3 text-end">
                                        <lord-icon src="{{ asset('/images/lordicons/receipt.json') }}" trigger="hover"
                    ...
                    <div class="col-md-3">
                        <div class="card bg-corner-img mb-2">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-9">
                                        <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Gastos del Mes</p>
                                        <h4 id="gastos_mes" class="mt-1 mb-0 fw-medium">—</h4>
                                    </div>
                                    <div class="col-3 text-end">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-9">
                                        ...
                                        <h4 id="monto_total_gastos" class="mt-1 mb-0 fw-medium">—</h4>
                                    </div>
                                    <div class="col-3 text-end">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-9">
                                        ...
                                        <h4 id="promedio_diario" class="mt-1 mb-0 fw-medium">—</h4>
                                    </div>
                                    <div class="col-3 text-end">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-sm bg-primary text-white" data-bs-toggle="modal"
                                    data-bs-target="#modalGasto" title="Agregar">
    ...
    <!-- Incluir modal -->
    @include('modales.leyma_gastos')
@endsection

@push('scripts')
    @vite(['resources/js/leyma_gastos.js'])
@endpush
