...
@section('content')
    <input type="hidden" id="id_usuario_perfil" value="{{ $usuario->id }}"
        data-auth="{{ $usuario->id === Auth::id() ? 'true' : 'false' }}">
        ...
        <div class="page-content py-2">
            <div class="container-fluid p-0">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        <div class="card">
                            <div id="fondo_portada_user" class="card-body p-4 rounded text-center img-bg"
                                style="background-image: url('{{ $usuario->imagen_fondo ? asset('storage/' . $usuario->imagen_fondo) : asset('storage/defaults/default_user_background.png') }}'); background-size: cover; background-position: center;">
                                <a id="btn_cambiar_imagen_fondo" href="#"><i
                                ...
                                <div class="row align-items-center">
                                    <div class="col ">
                                        <div class="d-flex align-items-center">
                                            <div class="position-relative">
                                                <img id="foto_portada_user"
                                                    src="{{ $usuario->imagen ? asset('storage/' . $usuario->imagen) : asset('storage/defaults/default_user.png') }}"
                                                    alt="Foto de perfil" class="rounded-circle img-fluid">

                                                <div class="position-absolute top-50 start-100 translate-middle">
                                                    <a id="btn_cambiar_imagen_foto" href="#"><i
                                                            class="las la-pen text-secondary fs-18"></i></a>
                                                </div>
                                            </div>

                                            <div class="flex-grow-1 text-truncate ms-3 align-self-end">
                                                <h5 class="m-0 fs-3 fw-bold">{{ $usuario->name }}</h5>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mt-3">
                                            <div class="text-body mb-2  d-flex align-items-center"><i
                                                    ...
                                                    class="text-body fw-semibold">Language :</span> English / French /
                                                Spanish</div>
                                            ...
                                            <button type="button"
                                                class="btn btn-sm btn-primary  d-inline-block">Follow</button>
                                            <button type="button" class="btn btn-sm btn-light  d-inline-block">Hire
                                                Me</button>
                                        </div>
                                    </div>
                                    <!--end col-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class=""><i
                                            class="las la-birthday-cake me-2 text-secondary fs-22 align-middle"></i>
                                ...
                                <div class="row justify-content-center mt-4">
                                    <div class="col-auto text-end border-end">
                                        ...
                                        <h4 class="m-0 fw-bold">25k <span
                                                class="text-muted fs-12 fw-normal">Followers</span></h4>
                                    </div>
                                    <!--end col-->
                                    <div class="col-auto">
                                        <span
                            ...
                            <div class="tab-pane active" id="post" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body pt-0">
                                                <form action="">
                                                    <div class="">
                                                        <textarea class="form-control form-control-sm  mb-2" id="post-1" rows="5" placeholder="Write here.."></textarea>
                                                        <button type="button"
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <img src="assets/images/extra/card/post-1.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="post-title mt-3">
                                                    <div class="row">
                                                        <div class="col">
                                                            <span
                                                                class="badge bg-primary-subtle text-primary">Natural</span>
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-auto">
                                                            <span class="text-muted"><i
                                                                    class="far fa-calendar me-1"></i>02
                                                                July 2024</span>
                                                        </div>
                                                        <!--end col-->
                                                    </div>
                                                    ...
                                                    <span class="fs-15 bg-light py-2 px-3 rounded">Taking pictures is
                                                        savouring life intensely.</span>
                                                    <p class="fs-15 mt-3">It is a long established fact that a reader will
                                                    ...
                                                    <p class="fs-15 mb-0">It is a long established fact that a reader will
                                                        be distracted by the readable content of
                                                        a page when looking at its layout. The point of using Lorem Ipsum is
                                                        that it has a
                                                        more-or-less normal distribution of letters, as opposed to using
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="bg-light rounded ms-n2 bg-light-alt p-3">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <p class="text-dark fw-semibold mb-2">Martin
                                                                                Luther</p>
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-auto">
                                                                            <span class="text-muted"><i
                                                                                    class="far fa-clock me-1"></i>30 min
                                                                                ago</span>
                                                                        </div>
                                                                        <!--end col-->
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="bg-light rounded ms-n2 bg-light-alt p-3">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <p class="text-dark fw-semibold mb-2">Joseph
                                                                                Rust</p>
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-auto">
                                                                            <span class="text-muted"><i
                                                                                    class="far fa-clock me-1"></i>40 min
                                                                                ago</span>
                                                                        </div>
                                                                        <!--end col-->
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="bg-light rounded ms-n2 bg-light-alt p-3">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <p class="text-dark fw-semibold mb-2">Matt
                                                                                Rosales</p>
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-auto">
                                            ...
                                            <div class="card-body pt-0">
                                                <form>
                                                    <div class="form-group mb-3">
                                                        <textarea class="form-control form-control-sm " rows="5" id="leave_comment" placeholder="Message"></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12 text-end">
                                                            <button type="submit"
                                                                class="btn btn-sm btn-primary px-4">Send
                                                                Message</button>
                                                        </div>
                                                    </div>
                                                </form>
                            ...
                            <div class="tab-pane p-3" id="settings" role="tabpanel">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="form-group mb-3 row">
                                            <label
                                                class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center form-label">Company
                                                Name</label>
                                            <div class="col-lg-9 col-xl-8">
                                                <input class="form-control form-control-sm " type="text"
                                                    value="MannatThemes">
                                                <span class="form-text text-muted font-12">We'll never share your email
                                                    with
                                                    anyone else.</span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm "
                                                        value="+123456789" placeholder="Phone"
                                        ...
                                        <div class="form-group mb-3 row">
                                            <label
                                                class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center form-label">Website
                                                Link</label>
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="input-group">
